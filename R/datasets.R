...
#'
#' @format A data frame with pedestrian counts.
#' @name data_73_74
#' @keywords datasets
NULL
...
#'
#' @format A list with location data.
#' @name location_71
#' @keywords datasets
NULL
...
#'
#' @format A data frame with location details.
#' @name locations
#' @keywords datasets
NULL
...
#'
#' @format A data frame with pedestrian counts per day.
#' @name ratio
#' @keywords datasets
NULL
...
#'
#' @format A data frame with station data.
#' @name corona_data_all
#' @keywords datasets
NULL
